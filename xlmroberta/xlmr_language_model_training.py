...
from XLMRSentimentPretraining import XLMRobertaForSentimentPretraining
...
def sentiment_enrichment():
    ...
    model = XLMRobertaForSentimentPretraining.from_pretrained('xlm-roberta-base', num_labels=num_labels)
    print("Train label:")
