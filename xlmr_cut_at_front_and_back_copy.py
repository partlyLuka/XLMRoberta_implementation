...
def crossvalidation_front_back():
    ...
    for i in range(10):
        ...
        ###
        config_file = f"/home/lukaa/first_task_on_ijs/sentiment_enrichment/models/sentiment_language_model_{i}/config.json"
        model_file = f"/home/lukaa/first_task_on_ijs/sentiment_enrichment/models/sentiment_language_model_{i}/pytorch_model.bin"
        ###
